...
import com.pragma.crediya.solicitudes.infrastructure.adapters.output.persistence.repository.IUsuarioRepository;
...
public class SolicitudPersistenceAdapter implements ISolicitudRepositoryPort {
    ...
    public Mono<SolicitudPrestamo> guardarSolicitud(SolicitudPrestamo solicitud) {
        ...
        return Mono.just(solicitud)
                ...
                .doOnNext(savedEntity -> log.debug("Solicitud guardada con ID: {}", savedEntity.getId()))
